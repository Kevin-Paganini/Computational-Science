...
command="horovodrun -np 2 -H localhost:2 python Lab10caltech256.py --data /data/datasets/caltech256 --batch_size 64 --epochs 30 --main_dir /home/paganinik/lab10 --augment_data true --fine_tune false"
